 ...
 * Share Component
 *
 * This component renders the share buttons for a recipe.
 * The share buttons include email, twitter, and facebook.
 *
 * @component
 *
 * @param {Object} props - The component props.
 * @param {Array<string>} props.instructions - The instructions for the recipe.
 * @param {Array<string>} props.ingredients - The ingredients for the recipe.
 * @param {string} props.title - The title of the recipe.
 * @param {string} props.recipeId - The id of the recipe.
 *
 * @returns {JSX.Element} A card body component that displays the share buttons for a recipe.
 */
export default function Share({ instructions, ingredients, title, recipeId }) {
  ...
  const emailLink = `mailto:?subject=${encodeURIComponent(
    title + " Recipe"
  )} &body=${encodeURIComponent(instructionsString)}`;
